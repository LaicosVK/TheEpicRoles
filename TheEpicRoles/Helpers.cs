    ...
    public static class Helpers
    {
        ...
        public static void turnToImpostor(PlayerControl player)
        {
            ...
            foreach (var player2 in PlayerControl.AllPlayerControls)
            {
                ...
                {
                    player2.cosmetics.nameText.color = Palette.ImpostorRed;
                }
            }
        }
        ...
        public static bool hidePlayerName(PlayerControl source, PlayerControl target) {
            ...
            else if (Phaser.isInvisble && Phaser.phaser == target) return true; 
        ...
        public static void setLook(this PlayerControl target, String playerName, int colorId, string hatId, string visorId, string skinId, string petId) {
            ...
            var spriteAnim = target.cosmetics.skin.animator;
            ...
            if (target.cosmetics.skin.layer.material == FastDestroyableSingleton<HatManager>.Instance.PlayerMaterial)
                PlayerControl.LocalPlayer.cosmetics.skin.SetColor(colorId);
            ...
            PlayerControl.LocalPlayer.cosmetics.SetPetColor(colorId);
        }
        ...
        public static void toggleZoom(bool reset=false) {
            ...
            HudManagerStartPatch.zoomOutButton.Sprite = HudManagerStartPatch.zoomOutStatus ? Helpers.loadSpriteFromResources("TheEpicRoles.Resources.PlusButton.png", 150f / zoomFactor * 2) : Helpers.loadSpriteFromResources("TheEpicRoles.Resources.MinusButton.png", 150f);
