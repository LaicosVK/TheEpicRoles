...
namespace TheEpicRoles.Objects {
    class Bloodytrail {
        ...
        public static List<Sprite> getBloodySprites() {
            ...
            sprites.Add(Helpers.loadSpriteFromResources("TheEpicRoles.Resources.Blood1.png", 700));
            sprites.Add(Helpers.loadSpriteFromResources("TheEpicRoles.Resources.Blood2.png", 500));
            sprites.Add(Helpers.loadSpriteFromResources("TheEpicRoles.Resources.Blood3.png", 300));
            return sprites;
        }
