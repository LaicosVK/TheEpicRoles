...
namespace TheEpicRoles.Objects 
{
    public class FootprintHolder : MonoBehaviour
    {
        ...
        private static Sprite FootprintSprite => _footprintSprite ??= Helpers.loadSpriteFromResources("TheEpicRoles.Resources.Footprint.png", 600f);

        private static bool AnonymousFootprints => TheEpicRoles.Detective.anonymousFootprints;
        private static float FootprintDuration => TheEpicRoles.Detective.footprintDuration;
