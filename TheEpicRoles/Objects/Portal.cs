    ...
    public class Portal {
        ...
        public static Sprite getFgAnimationSprite(int index) {
            ...
            if (portalFgAnimationSprites[index] == null)
                portalFgAnimationSprites[index] = (Helpers.loadSpriteFromResources($"TheEpicRoles.Resources.PortalAnimation.portal_{(index):000}.png", 115f));
        ...
        public Portal(Vector2 p) {
            ...
            bool playerIsPortalmaker = CachedPlayer.LocalPlayer.PlayerControl == TheEpicRoles.Portalmaker.portalmaker;
        ...
        private static void preloadSprites() {
            ...
            portalSprite = Helpers.loadSpriteFromResources("TheEpicRoles.Resources.PortalAnimation.plattform.png", 115f);
        }
