...
using Types = TheEpicRoles.CustomOption.CustomOptionType;
...
namespace TheEpicRoles {
    public class CustomOptionHolder {
        ...
        public static CustomOption phaserInvisibleDuration;
        ...
        public static void Load() {
            ...
            phaserSpawnRate = CustomOption.Create(380, Types.Impostor, cs(Phaser.color, "Phaser"), rates, null, true);
            phaserCooldown = CustomOption.Create(381, Types.Impostor, "Phaser Mark Cooldown", 30f, 10f, 120f, 5f, phaserSpawnRate);
            phaserKnowsTargetLocation = CustomOption.Create(382, Types.Impostor, "Phaser Knows Location Of Target", true, phaserSpawnRate);
            phaserTraceTime = CustomOption.Create(383, Types.Impostor, "Trace Duration", 5f, 1f, 20f, 0.5f, phaserSpawnRate);
            phaserTraceColorTime = CustomOption.Create(384, Types.Impostor, "Time Till Trace Color Has Faded", 2f, 0f, 20f, 0.5f, phaserSpawnRate);
            phaserInvisibleDuration = CustomOption.Create(385, Types.Impostor, "Time The Phaser Is Invisble", 3f, 0f, 20f, 1f, phaserSpawnRate);
            ...
            amnesiacResetRole = CustomOption.Create(618, Types.Neutral, cs(Amnesiac.color, "Reset Role When Taken"), false, amnesiacSpawnRate);
